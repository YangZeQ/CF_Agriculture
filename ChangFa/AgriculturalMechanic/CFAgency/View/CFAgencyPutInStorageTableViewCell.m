//
//  CFAgencyPutInStorageTableViewCell.m
//  ChangFa
//
...
@interface CFAgencyPutInStorageTableViewCell ()
...
@end
@implementation CFAgencyPutInStorageTableViewCell

- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        self.selectionStyle = UITableViewCellSelectionStyleNone;
        [self createPutInStorageCell];
    }
    return self;
}
- (void)createPutInStorageCell{
    
    _machineImage = [[UIImageView alloc]initWithFrame:CGRectMake(30 * screenWidth, 30 * screenHeight, 180 * screenWidth, 180 * screenHeight)];
